...
const APE_LUCKY_COIN_BASE_URL = process.env.URL ?? throwExpression("Please define APE_LUCKY_COIN_BASE_URL");
...
function response(tokenId: string, gifUrl: string) {
    return {
        ...
        "description": `#[${tokenId}]`,
        "image": gifUrl,
        "external_url": `${APE_LUCKY_COIN_BASE_URL}/coin/${tokenId}`
    };
}

export const renderApeLuckyCoin = async (req: Request, res: Response) => {
