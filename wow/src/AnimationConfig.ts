...
export default class AnimationConfig {
    static levelConfig = [2, 2, 3, 3, 3, 2, 2];
    static levelRarityConfig = [3, 3, 3];
    ...
    public static generate(seed: string | number): AnimationConfig {
        ...
        const divider = new AreaDivider(r.randomItems(AnimationConfig.levelConfig, r.randomItems(AnimationConfig.levelRarityConfig, 1)[0]), 16, 16, r);
